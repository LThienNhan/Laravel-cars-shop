    ...
    <form action="<?php echo e(route('admin.settings.update')); ?>" method="POST" role="form">
        ...
        <div class="tile-body">
            <div class="form-group">
                ...
                ><?php echo Config::get('settings.google_analytics'); ?></textarea>
            </div>
            <div class="form-group">
                ...
                ><?php echo e(Config::get('settings.facebook_pixels')); ?></textarea>
            </div>
        </div>
...
<?php /**PATH E:\Xampp\htdocs\Laravel-cars-shop\resources\views/admin/settings/includes/analytics.blade.php ENDPATH**/ ?>