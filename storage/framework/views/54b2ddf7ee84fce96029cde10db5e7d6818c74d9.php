...
<img src="frontend/images/product/super-bike-motor-sport-logo-design-vector-197271890.jpg" style="margin-top:50px"width="80%" height="80%" alt="">
</div>
</div>
</div>

<div class="row" style="background-image:url(frontend/images/product/anh-nen-ducati-mau-trang.jpg);background-color: transparent;margin-top:">
...
<?php echo $__env->make('site.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Xampp\htdocs\Laravel-cars-shop\resources\views/site/pages/homepage.blade.php ENDPATH**/ ?>