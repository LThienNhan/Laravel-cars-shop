        ...
        <div class="tile-body">
            <div class="form-group">
                ...
                <input
                    ...
                    value="<?php echo e(config('settings.social_facebook')); ?>"
                />
            </div>
            <div class="form-group">
                ...
                <input
                    ...
                    id="social_twitter"
                    name="social_twitter"
                    value="<?php echo e(config('settings.social_twitter')); ?>"
                />
            </div>
            <div class="form-group">
                ...
                <input
                    ...
                    value="<?php echo e(config('settings.social_instagram')); ?>"
                />
            </div>
            <div class="form-group">
                ...
                <input
                    ...
                    value="<?php echo e(config('settings.social_linkedin')); ?>"
                />
            </div>
        </div>
...
<?php /**PATH E:\Xampp\htdocs\Laravel-cars-shop\resources\views/admin/settings/includes/social_links.blade.php ENDPATH**/ ?>